...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= base_url('assets/img/logo/'); ?><logo-pb class=" png">
    <link rel="stylesheet" href=" <?= base_url('assets/'); ?>user/css/bootstrap.css">
    <link href="<?= base_url('assets/'); ?>vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link href=<?= base_url('assets/'); ?>datatable/datatable.css" rel="stylesh eet" type="text/css">
</head>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMakeup">
                <div class="navbar-nav">
                    <a class="nav-item nav-link active" href="<?= base_url(); ?>">Beranda <span class="sr-only">(cureent)</span></a>
                    <?php
                    ...
                    <?php } else { ?>
                        <a class="new-item nav-link" data-toggle="modal" data-target="#daftarModal" href="#daftarModal"><i class="fas fw fa-login"></i> Daftar</a>
